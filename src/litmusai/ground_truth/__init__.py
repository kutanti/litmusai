...
def apply_ground_truth(
    ...
    Retains matching ground truth entries even when assertions exist.
    Generates assertions only for cases without existing assertions.
    ...
    Returns:
        Number of cases with newly generated assertions.
    """
    updated = 0
